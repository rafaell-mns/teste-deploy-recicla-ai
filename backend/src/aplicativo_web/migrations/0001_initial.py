# Generated by Django 5.2.7 on 2025-11-23 18:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('SOLICITADA', 'Solicitada'), ('ACEITA', 'Aceita'), ('CANCELADA', 'Cancelada'), ('CONFIRMADA', 'Confirmada'), ('AGUARDANDO', 'aguardando'), ('CONCLUIDA', 'concluida')], default='SOLICITADA', max_length=55)),
